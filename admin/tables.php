                ...
                <div class="modal-dialog modal-lg " role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <hr class="custom">
                            <p class="custom"><b>Foto Laporan</b></p>
                            <p class="custom"><td><img src="/pengaduan/foto/<?= $key['foto']; ?>" alt="Foto Laporan" style="width:300px; height: auto;"/></td></p>
                            <hr class="custom">
                        ...
                        <div class="modal-body">
                            <form method="post">
                                ...
                                <div class="from-group">
                                    <p><b>Foto Laporan</b></p>
                                    <p><td><img src="/pengaduan/foto/<?= $key['foto']; ?>" alt="Foto Laporan" style="width:100px; height: auto;"/></td></p>
                                    <hr>
                                </div>
                                <div class="form-group">
                                    <p><b>Tanggapan :</b></p>
        ...
        <footer class="sticky-footer">
            <div class="container">
                <div class="text-center">
                    <small>Copyright © DSMjayasampurna</small>
                </div>
            </div>
        </footer>
        ...
        <div class="modal fade" id="VersionModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h5 style="text-align : center;">V-6</h5>
                        <p style="text-align : center;">Copyright © DSMjayasampurna</p>
                    </div>
                    <div class="modal-footer">
